				...
				<div className={classes.ContainerFlex}>
					...
					<div className={classes.Content}>
						<div className={classes.ProfilePicture}>
							...
							{formState.inputs.picture.value ? formState.inputs.picture.value.size > 500000 ? (
								<span>
						...
						<div className={classes.ContentTop}>
							<div className={classes.ContentLeft}>
								...
								<div className={classes.ContentWrap}>
									...
									<FormControl className={classes.formControl} style={{ marginTop: '0rem' }}>
										...
										<Select
											...
											{LocationData.sort().map((loc, i) => {
												return (
													<MenuItem id={i} value={loc} style={{ fontSize: '0.9rem' }} key={i}>
														{loc}
													</MenuItem>
												);
											})}
								...
								<div className={classes.ContentWrap}>
									<FormControl className={classes.formControl} style={{ marginTop: '0.5rem' }}>
								...
								<div className={classes.ContentWrap} style={{ marginTop: '0.5rem' }}>
									<div>
									...
									<div id='gender' onChange={onManualInputHandler} style={{ marginTop: '-1rem' }}>
						...
						<div className={classes.ContentBottom}>
							...
							<label onChange={onCheckedInputHandler} className={classes.CheckBox}>
								...
								<p style={{ margin: '0', marginLeft: '4px' }}>Berikan notifikasi bila ada pekerjaan sesuai bidang minat</p>
							</label>
							<label onChange={onCheckedInputHandler} className={classes.CheckBox}>
