		...
		content = (
			<form className={classes.Container}>
				...
				<p className={classes.AppealText}>
					...
					untuk konfirmasi anda berhenti dari fitur notifikasi otomatis (auto reminder) dan/atau fitur lamaran otomatis (auto
					apply) , keluar dari halaman bila anda tidak ingin melakukan pembaruan
				</p>
